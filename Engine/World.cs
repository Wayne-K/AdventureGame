...
namespace Engine
{
    public static class World
    {
        ...
        private static void PopulateQuests()
        {
            ...
            clearAlchemistGarden.completionItems.Add(new QuestCompletionItem(ItemByID(ITEM_ID_RAT_TAIL), 3));
            ...
            clearFarmersField.completionItems.Add(new QuestCompletionItem(ItemByID(ITEM_ID_SNAKE_FANG), 3));
